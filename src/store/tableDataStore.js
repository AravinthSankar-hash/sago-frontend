...
export const useUpdateCurrentSelectedRowData = () =>
  useTableDataStore((state) => state.updateCurrentSelectedRowData);
...
export const useUpdateShowCatalogBackBtn = () =>
  useTableDataStore((state) => state.updateShowCatalogBackBtn);
export const useCatalogTabIndex = () => useTableDataStore((state) => state.catalogTabIndex);
export const useUpdateCatalogTabIndex = () =>
  useTableDataStore((state) => state.updateCatalogTabIndex);
export const useShowCatalogTabHomePage = () =>
  useTableDataStore((state) => state.showCatalogTabHomePage);
export const useUpdateShowCatalogTabHomePage = () =>
  useTableDataStore((state) => state.updateShowCatalogTabHomePage);
