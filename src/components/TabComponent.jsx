...
const TabComponent = (props) => {
  ...
  return (
    ...
    <Tabs
      ...
      <Tab value="purchase" sx={{ textTransform: 'none' }} tabIndex={0} label="Purchase"  style={purchaseTab} onClick={() => props.showTab(true)}/>
      <Tab value="payments" sx={{ textTransform: 'none' }} label="Payments"  style={paymentTab} onClick={() => props.showTab(false)}/>
    </Tabs>
    </div>
